...
{
	/**
	 * @brief This data list is designed for layout. 
	 */
	...
	/**
	 * @brief To calculate the size of bufferElement type
	 */
	...
	/**
	 * @brief The BufferElemet in layout
	 */
	struct BufferElement
	{
		std::string     Name;       ///The name of element
		ShaderDataType  Type;		///The shaderDataType of element
		uint32_t        Size;		///The size of this element
		...
		/**
		 * @brief Get the count of the layout component
		 */
	...
	/**
	 * @brief The class to set Vertexbuffer attribute
	 */
	class BufferLayout
	{
	public:
	...
	/**
	 * @brief This is the abstract class of IndexBuffer
	 */
	class IndexBuffer
	{
	public:
