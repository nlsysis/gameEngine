...
namespace Engine
{
	...
	public:
		...
		/**
		 * @brief open the output file and write the
		 */
		void  BeginSession(const std::string& name, const std::string& filepath = "reesults.json")
		{
	...
	/**
	 * @brief The simple timer for profiling
	 */
...
#define EG_PROFILE 1
	...
	#define EG_PROFILE_FUNCTION()  EG_PROFILE_SCOPE(__FUNCSIG__) //void __cdecl Engine::Instrumentor::Stop(void)
#else
